            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <br>
                     ...
                     <br>
                      <label  style="font-size:20px;font-family: serif;;margin-top: 30px;margin-left: 60px;">Educational Details :</label> 
                    <br>
                    <center style="margin-left: 30px;">
           <input type="text" style="font-family:serif;margin-top: 30px;" placeholder="Enter School Name" name="#" required>
                    ...
                    <select  class="form-control"  name="#" style="border-radius: 15px;background: #f1f1f1;width: 6cm;">
                        ...
                        <br> 
                         <input type="text" style="font-family:serif" placeholder="Enter College Name" name="#" required>
                    ...
                    <br>
                    <a href="student_reg4"><button type="button" class="btn btn-success" style="margin-left: 170px;font-size: 15px;">Next</button></a>
                     </center>
                </div>
