            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <br>
                     ...
                     <br>
                      <label  style="font-size:20px;font-family: serif;;margin-top: 30px;margin-left: 60px;">Requirement Details :</label> 
                    <br>
                    <center style="margin-left: 30px;">
         <input type="text" style="font-family:serif;margin-top: 30px;" placeholder="Enter Tution Title" name="#" required>
               
                     <br>
                     
                     
                     <select  class="form-control"  name="#" style="border-radius: 15px;background: #f1f1f1;width: 6cm;">
                        <option >-: Tution Requires For :-</option>
                        <option> Male</option>
                     ...
                     <select  class="form-control"  name="#" style="border-radius: 15px;background: #f1f1f1;width: 6cm;">
                      ...
                      <br>
                     <textarea id="textarea" rows="3" cols="40" style="border-radius: 10px;margin-left: 70px;" placeholder="Enter Remarks"></textarea>
                     <br>
                   
                    <br>
                    <a href=""><button type="button" class="btn btn-success" style="font-size: 15px;">Register</button></a>
                     </center>
                </div>
