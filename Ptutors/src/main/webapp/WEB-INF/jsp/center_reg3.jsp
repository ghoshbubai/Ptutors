            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <br>
                     ...
                     <br>
                      <label  style="font-size:20px;font-family: serif;;margin-top: 30px;margin-left: 60px;">Academic Details :</label> 
                    <br>
                    <center style="margin-left: 30px;">
      <textarea id="textarea" style="margin-top: 30px;margin-left: 70px;" rows="3" cols="40"  placeholder="Enter Course Offered"></textarea>
                     
                      <textarea id="textarea" rows="3" cols="40" style="border-radius: 10px;margin-left: 70px;" placeholder=" Enter Faculty Details"></textarea>
                      <textarea id="textarea" rows="3" cols="40" style="border-radius: 10px;margin-left: 70px;" placeholder=" Enter Success/Achivement"></textarea>
                     <br>
                   
                    <br>
                    <a href="#"><button type="button" class="btn btn-success" style="font-size: 15px;margin-left: 50px;">Register</button></a>
                     </center>
                </div>
