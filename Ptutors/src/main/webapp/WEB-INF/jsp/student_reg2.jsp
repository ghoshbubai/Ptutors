        ...
        <div class="container-fluid">
            <div class="row">
               ...
               <input type="text" style="font-family:serif;margin-top: 30px;" placeholder="Enter Name" name="#" required>
                   ...
                   <textarea id="textarea" rows="3" cols="40" style="border-radius: 10px;margin-left: 70px;" placeholder="Enter Address"></textarea>
                     <br>
                     <input type="text" style="font-family:serif" placeholder="Enter Guardian Name" name="#" required>
                    <br>
               ...
               <br>
                    <input type="text" style="font-family:serif" placeholder="Enter Preffered Call Timing" name="#" required>
               
                    
                      <br> 
                  <a href="student_reg3"><button type="button" class="btn btn-success" style="margin-left: 170px;font-size: 15px;">Next</button></a>
                     </center>
                    <br>
                    <br>
                </div>
