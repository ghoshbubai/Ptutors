...
<body style="background: lightblue">
	...
	<nav class="navbar navbar-default"
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav"
				...
				<li onmouseover="this.style.backgroundColor = '#5E616C'"
					onmouseout="this.style.backgroundColor = ''"><a href="student"><b
						id="menu" style="color: whitesmoke;">Student</b></a></li>
				<li onmouseover="this.style.backgroundColor = '#5E616C'"
				...
				<li onmouseover="this.style.backgroundColor = '#5E616C'"
					onmouseout="this.style.backgroundColor = ''"><a
					href="jsp/academia.jsp"><b id="menu" style="color: whitesmoke;">Academia</b></a></li>
				<li onmouseover="this.style.backgroundColor = '#5E616C'"
					onmouseout="this.style.backgroundColor = ''"><a href="#"><b
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-4">
				<br> <label style="font-size: 35px; font-family: serif">Tutorial
					Center Log In :</label> <br>

				<center style="margin-left: 30px;">
					<input type="text" style="font-family: serif; margin-top: 40px;"
						placeholder="Username" name="#" required> <br> <input
						type="password" style="font-family: serif" placeholder="Password"
						name="#" required> <br> <a href="#"><button
							type="button" class="btn btn-success" style="font-size: 15px;">Log
							In</button></a> &nbsp; &nbsp;<a href='' style="color: red;"
						style='font-family: serif'> Forgot Password ?</a> <br> <br>
					<b style="color: darkslategrey;" style='font-family: serif'>
						Don't have an account ?</b>&nbsp; <a href="center_reg1"><button
							type="button" class="btn btn-success" style="font-size: 15px;">Register</button></a>
				</center>
			</div>
