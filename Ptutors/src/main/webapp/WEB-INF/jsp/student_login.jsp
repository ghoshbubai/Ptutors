    ...
    <body style="background:lightblue" >
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <br>
                    <label  style="font-size:35px;font-family: serif">Student Log In :</label> 
                     <br>
                     
                    <center style="margin-left: 30px;">
                      <input type="text" style="font-family:serif;margin-top: 40px;" placeholder="Username" name="#" required>
                    <br>
                    <input type="password" style="font-family:serif" placeholder="Password" name="#" required>
                    
                     
                    
                   
                    <br>
                    <a href="#"><button type="button" class="btn btn-success" style="font-size: 15px;">Log In</button></a>
                    &nbsp; &nbsp;<a href='' style="color: red;" style='font-family: serif'> Forgot Password ?</a>
                    <br>
                    <br>
                    <b style="color: darkslategrey;" style='font-family: serif'> Don't have an account ?</b>&nbsp; <a href="student_reg1"><button type="button" class="btn btn-success" style="font-size: 15px;">Register</button></a>
                     </center>
                </div>
