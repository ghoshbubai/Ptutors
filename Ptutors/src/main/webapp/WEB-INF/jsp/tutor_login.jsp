...
<body style="background: lightblue">
	...
	<div class="container-fluid">
		<div class="row"
			...
			<div class="col-lg-2" id="image">
				<img src="src/main/webapp/resources/logo/logon.gif" alt="" />
				<div class="middle">
					<div class="text">
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-4">
				<br> <label
					style="font-size: 35px; font-family: serif; color: teal;">Tutor
					Log In...</label> <br>
				<form action="tutorLogin" method="post">
					<center style="margin-left: 30px;">
						...
						<input type="password" style="font-family: serif"
							placeholder="Password" name="password" required> <br>
						<a href="#"><input type="submit" value="Log In" class="btn btn-success"
							style="font-size: 15px;">
							</button></a> &nbsp; &nbsp;<a href='' style="color: red;"
							style='font-family: serif'> Forgot Password ?</a> <br> <br>
						<b style="color: darkslategrey;" style='font-family: serif'>
							Don't have an account ?</b>&nbsp; <a href="tutor_reg"><button
