        ...
        <div class="container-fluid" onmouseover="this.style.backgroundColor = '#456A5D'" onmouseout="this.style.backgroundColor = '#345370'" style="margin-left: 0px;padding: 0px;">
            <div class="row" style="margin-left: 0px;padding-left: 0px;">
                ...
                <div class="col-lg-12" >
                    <br>
                    <center>
                        <h4 style="font-size: 30px;color: whitesmoke;font-family: serif"><b>Students's Arena</b></h4>
                       ...
                       <br>
                        ...
                        <div class="col-lg-2"></div>
                        <div class="col-lg-8">
                            <h5 style="font-size: 30px;color: whitesmoke;font-family: serif"><span class="glyphicon glyphicon-share"></span> How it works for Students</h5>
                            <hr>
                        <p class="text-justify" style="font-size: 20px;color: whitesmoke;font-family: serif;">
                            1. Easy accessibility for the students to find desired tutors anytime, anywhere and in any subject.
                            <br>2. Provisions for students to share and exchange study materials 
                            essential for the last minute 
                            work or an &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;examination or in delivering a presentation.
<br>3. Student can search his/her suitable tutors for any area any subject on the globe.
<br>4. Updates students with the latest news regarding competitive examinations ,admissions etc.
                        ...
                        <div class="col-lg-2"></div>
                        <div class="col-lg-8">
                            <h5 style="font-size: 30px;color: whitesmoke;font-family: serif"><span class="glyphicon glyphicon-share"></span> For Students</h5>
                            <hr>
                        <p class="text-justify" style="font-size: 20px;color: whitesmoke;font-family: serif;">
                            <b>1. How do I find tutors from your website?</b><br><br>
                            <span class="text-justify">The professional tutors provides a list of tutors along with the 
                                necessary information in the View Tutor Profile of the Tutors Arena section. Tutors can 
                                also be directly found from the Find Your Tutor in the Post tuition section.
                                An upgraded registration will entitle students to seek further information of the tutor .</span><br>
